...
const CreateVandor = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existingVandor !== null) {
        return res.json({ "message": "A vandor is exists with this email id" });
    }
    // generate a salt
    const salt = yield (0, utility_1.GenerateSalt)();
    //  encrypt the password using the split
...
const GetVandorById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.json({ "message": "vandors data not available by ID" });
});
